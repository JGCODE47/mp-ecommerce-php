                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <button class="mercadopago-button" id="mercadopago" name_product="<?php echo $_POST['title'] ?>" price="<?php echo $_POST['price'] ?>" unit="<?php echo $_POST['unit'] ?>">Pagar</button>
                                </div>
                            </div>
                        </div>
                    </div>
